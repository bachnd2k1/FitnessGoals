...
internal enum L10n {
  ...
  /// Open Settings
  internal static let denyLocationAction = L10n.tr("Localizable", "deny_location_action", fallback: "Open Settings")
  ...
  /// Allow permisson
  internal static let requestLocationAction = L10n.tr("Localizable", "request_location_action", fallback: "Allow permisson")
